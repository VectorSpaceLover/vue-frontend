    ...
    <div v-if="isLoading === false" class='mh-100v'>
        <div class="d-flex flex-row justify-space-between">
            ...
            <div class="d-flex flex-row">
                <div class="d-flex flex-column">
                        <div>ARROWPOINT CAPITOL CORP</div>
                        <div>P. O. BOX 19809</div>
                        <div>{{`${$data.number5.patientAddress}, NC 28219-0809`}}</div>
                </div>
            </div>
             <div class="d-flex flex-row">
                <v-btn
        ...
        <div class="hcfa-container">
                            ...
                            <v-col cols = '7' md = '7' sm = '7'>
                                ...
                                <v-row>
                                    ...
                                    >
                                        ...
                                        <p class="pt-5 bb-1">{{$data.number5.patientTelephone}}</p>
                                    </v-col>
                                </v-row>
                            </v-col>
                    ...
                    >
                        <div class="d-flex flex-column align-start">
                            ...
                            <div class="d-flex flex-row align-center">
                                ...
                                <span class="ml-3 f-11"><b>If yes</b>, return to and complete item 9 a-d</span>
                            </div>
                        </div>
                                ...
                                <div class="bb-1">
                                    <v-row>
                                        ...
                                        <v-col cols='3' md= '3' sm = '3' class="lb-1">
                                            <v-text-field v-model="number17.a.first" placeholder="" type="text" :hide-details = true :value="`${number17.a.first}`"></v-text-field>
                                        </v-col>
                                        <v-col cols='6' md= '6' sm = '6' class="lb-1">
                                            <v-text-field v-model="number17.a.second" placeholder="" type="text" :hide-details = true :value="`${number17.a.second}`"></v-text-field>
                                        </v-col>
                                    </v-row>
                                </div>
                                <div>
                ...
                <v-row class="bb-1">
                    <v-col
                        ...
                        md="8"
                    >
                        <p>21. DIAGNOSIS OR NATURE OF ILLNESS OR INJURY (Relate Items 1, 2, 3 or to item 24E by Line)</p>
                        <v-row>
                            <v-col
                                v-for="(item, i) in number21.first" :key="'number21' + i"
                                cols="6"
                                sm="6"
                                md="6"
                            >
                                <div class="d-flex flex-row align-center">
                                    ...
                                    <v-text-field v-model="number21.first[i]" placeholder="" type="text" :hide-details = true :value="`${item}`"></v-text-field>
                                </div>
                            </v-col>
                        </v-row>
                        <v-row>
                            <v-col
                                v-for="(item, i) in number21.second" :key="'number21' + (i + 2)"
                                cols="6"
                                sm="6"
                                md="6"
                            >
                                <div class="d-flex flex-row align-center">
                                    ...
                                    <v-text-field v-model="number21.second[i]" placeholder="" type="text" :hide-details = true :value="`${item}`"></v-text-field>
                                </div>
                            </v-col>
                        </v-row>
                    </v-col>
                    ...
                    >
                        ...
                        <v-row>
                            ...
                            >
                                <p>CODE</p>
                                <v-text-field v-model="number22.code" placeholder="code" type="text" :hide-details = true :value="`${number22.code}`"></v-text-field>
                            </v-col>
                            ...
                            >
                                <p>ORIGINAL.REF.NO</p>
                                <v-text-field v-model="number22.no" placeholder="original ref no" type="text" :hide-details = true :value="`${number22.no}`"></v-text-field>
                            </v-col>
                        </v-row>
                        <p>23. PRIOR AUTHORIZATION NUMBER</p>
                        <v-col
                        >
                            <v-text-field v-model="number23.value" placeholder="prior authorization number" type="text" :hide-details = true :value="`${number23.value}`"></v-text-field>
                        </v-col>
                    </v-col>
                </v-row>
                <!-- Line 12 -->
                    ...
                    >
                        <v-row>
                            ...
                            >
                                ...
                                <v-row>
                                    <v-col cols="6" md='6' sm='6' class="d-flex flex-column align-center">
                                        <span>FROM</span>
                                        <v-row align="center">
                                            <v-col 
                                                cols="4"
                                            ...
                                            >
                                                <p>MM</p>
                                                <v-text-field v-model="number24.a.mm" placeholder="mm" type="text" :hide-details = true :value="`${number24.a.mm}`"></v-text-field>
                                            </v-col>
                                            <v-col 
                                                cols="4"
                                                md="4"
                                            ...
                                            >
                                                <p>DD</p>
                                                <v-text-field v-model="number24.a.dd" placeholder="dd" type="text" :hide-details = true :value="`${number24.a.dd}`"></v-text-field>
                                            </v-col>
                                            <v-col
                                                cols="4"
                                                md="4"
                                            ...
                                            >
                                                <p>YY</p>
                                                <v-text-field v-model="number24.a.yy" placeholder="yy" type="text" :hide-details = true :value="`${number24.a.yy}`"></v-text-field>
                                            </v-col>
                                        </v-row>
                                    </v-col>
                                    <v-col cols="6" md='6' sm='6' class="d-flex flex-column align-center">
                    ...
                    >
                        <v-row>
                            <v-col v-for="(col, n) in 14" :key="'numberstr' + ii + '-' + n">
                                <v-text-field v-model="strArray[ii][n]" placeholder="enter" type="text" :hide-details = true :value="`${strArray[ii][n]}`"></v-text-field>
                            </v-col>
                        </v-row>
                    </v-col>
                    ...
                    >
                        <v-row>
                            <v-col v-for="(col2, n2) in 6" :key="'numberstr' + ii + '-' + n2">
                                <v-text-field v-model="strArray[ii][ n2 + 14 ]" placeholder="enter" type="text" :hide-details = true :value="`${strArray[ii][n2 + 14]}`"></v-text-field>
                            </v-col>
                        </v-row>
                    </v-col>
                </v-row>
...
export default {
    ...
    methods: 
    {
        openHcfa(){
            ...
            this.$api.get(`/hcfa/?id=${this.$auth.user.uuid}&patientId=${this.currentName.user_uuid}`).then((res) => {
                ...
                if(res?.status === 200 && res.data){
                    ...
                    this.number2.patientName = patientInfo.user_last_name + ' ' + patientInfo.user_first_name;
        ...
        makeXml(){
            ...
            // Line 17
            xmlbody = xmlbody + '<number21>\n\t\t<first>' + this.number21.first[0] + 
                                    '</first>\n\t\t<second>' + this.number21.first[1] + 
                                    '</second>\n\t\t<third>' + this.number21.second[0] + 
                                    '</third>\n\t\t<fourth>' + this.number21.second[1] + 
                                    '</fourth>\n\t</number21>\n\t';

            // Line 18
            xmlbody = xmlbody + '<number22>\n\t\t<code>' + this.number22.code + 
                                    '</code>\n\t\t<no>' + this.number22.no + 
                                    '</no>\n\t</number22>\n\t';
            ...
            // Line 20
            xmlbody = xmlbody + '<number24>\n\t\t<from>\n\t\t\t<month>' + this.number24.a.from.mm + 
                                    '</month>\n\t\t\t<day>' + this.number24.a.from.dd + 
                                    '</day>\n\t\t\t<year>' + this.number24.a.from.yy + 
                                    '</year>\n\t\t</from>\n\t\t<to>\n\t\t\t<month>' + this.number24.a.to.mm + 
                                    '</month>\n\t\t\t<day>' + this.number24.a.to.dd + 
                                    '</day>\n\t\t\t<year>' + this.number24.a.to.yy + 
                                    '</year>\n\t\t</to>\n\t</number24>\n\t';
        ...
        async created() {
            ...
            const sendingData = { id: this.$auth.user.uuid, patientId: this.currentName.user_uuid, hcfaInfo: {
                number1: this.number1, number8: this.number8,
                number9: this.number9, number10: this.number10, number11: this.number11, number14: this.number14, number15: this.number15, number16: this.number16,
                number18: this.number18, number19: this.number19, number20: this.number20,
                number21: this.number21, number22: this.number22, number23: this.number23, number24: this.number24,
                number27: this.number27, number28: this.number28,
                number29: this.number29, number30: this.number30, strArray: this.strArray,
            } };
